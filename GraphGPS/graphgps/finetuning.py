...
def load_pretrained_model_cfg(cfg):
    pretrained_cfg_fname = osp.join(cfg.pretrained.gwas_dir, 'config.yaml')
    ...
    assert cfg.model.type in ["GPSModel", "PrefixGPSModel", "Graphormer"], \
...
def init_model_from_pretrained(model, pretrained_dir,
    ...
    del model_dict['model.post_mp.FC_layers.2.weight']
    del model_dict['model.post_mp.FC_layers.2.bias']
    del model_dict['model.encoder.edge_encoder.bond_embedding_list.0.weight']
    del model_dict['model.encoder.edge_encoder.bond_embedding_list.1.weight']
    del model_dict['model.encoder.edge_encoder.bond_embedding_list.2.weight']

    try:
        del model_dict['model.encoder.node_encoder.encoder1.atom_embedding_list.0.weight']
        del model_dict['model.encoder.node_encoder.encoder1.atom_embedding_list.1.weight']
        del model_dict['model.encoder.node_encoder.encoder1.atom_embedding_list.2.weight']
        del model_dict['model.encoder.node_encoder.encoder1.atom_embedding_list.3.weight']
        del model_dict['model.encoder.node_encoder.encoder1.atom_embedding_list.4.weight']
        del model_dict['model.encoder.node_encoder.encoder1.atom_embedding_list.5.weight']
        del model_dict['model.encoder.node_encoder.encoder1.atom_embedding_list.6.weight']
        del model_dict['model.encoder.node_encoder.encoder1.atom_embedding_list.7.weight']
        del model_dict['model.encoder.node_encoder.encoder1.atom_embedding_list.8.weight']
    except KeyError:
        pass
    ...
    try:
        ...
        old_embed = model_dict['model.encoder.node_encoder.encoder1.atom_embedding_list.1.weight']
        new_embed = torch.cat((old_embed, torch.mean(old_embed, dim=0).unsqueeze(0)), dim=0)
        model_dict['model.encoder.node_encoder.encoder1.atom_embedding_list.1.weight'] = new_embed
        model.load_state_dict(model_dict, strict=False)

    if freeze_main:
        for key, param in model.named_parameters():
            if 'layers' in key and '15' not in key:
