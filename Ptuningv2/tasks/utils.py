...
GRAPH_DATASETS = ["ogb/ogbg-molhiv", "bace", "bbbp", "tox21", "clintox", "chembl29", "esol", "estrogen", "freesolv",
                  "lipo", "metstab", "sider", "toxcast", "molhiv", "pcba", "ppa"] + list_datasets()


TASKS = ["glue", "superglue", "ner", "srl", "qa", "graph", "light", "gps"]

DATASETS = GLUE_DATASETS + SUPERGLUE_DATASETS + NER_DATASETS + SRL_DATASETS + QA_DATASETS + GRAPH_DATASETS
