...
class DataTrainingArguments:
    ...
    data_path: Optional[str] = field(
        default=None,
        metadata={
            "help": "The path of the kpgt dataset to use",
        }
    ...
    path_length : Optional[int] = field(
        default=5,
        metadata={
            "help": "The length of path of the kpgt dataset to use",
        }
    )
    ...
    dataset_type: Optional[str] = field(
        ...
        metadata= {
            "help": "The type of the kpgt dataset to use",
            "choices": ["binary classification", "regression", "multitask"]
    ...
    split_mode: Optional[str] = field(
        default="random",
        metadata={
            "help": "Type of the dataset split"
        }
    )
    ...
    metric: Optional[str] = field(
        default=None,
        metadata={
            "help": "The evaluation metric of the dataset",
        }
    )
    ...
    split: Optional[str] = field(
        default="scaffold-0",
        metadata={
            "help": "The split of the kpgt dataset to use"
        }

    )

    cv: Optional[bool] = field(
        default=False,
        metadata={
    ...
    n_threads: Optional[int] = field(
        default=1,
        metadata={
            "help": "The number of workers of the kpgt dataset to use"
        }
...
class ModelArguments:
    ...
    lightweight: bool = field(
        default=False,
        metadata={
            "help": "Will use lightweight fine-tuning during training"
        }
    )
    ...
    prefix_layer_min: int = field(
        default=0,
        metadata={
            "help": "the first layer to inject prompts to"
        }
    )
    prefix_layer_max: int = field(
        default=-1,
        metadata={
            "help": "the last layer to inject prompts to"
        }
    )
